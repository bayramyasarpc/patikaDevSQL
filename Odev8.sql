...
CREATE TABLE author ( id INTEGER, name VARCHAR(50), birthday DATE, email VARCHAR(100) );
...
UPDATE employee SET name = 'Emirhan Uzun', birthday = '1999-06-07' WHERE id BETWEEN 7 AND 11;

4-)Sütunların her birine göre ilgili satırı silecek 5 adet DELETE işlemi yapalım.
DELETE FROM employee WHERE id BETWEEN 34 AND 38 RETURNING *;
